...
public class MainMenuActivity extends AppCompatActivity
    ...
    TextView txt_verNome, txt_verEmpresa;
...
//        R.string.nav_header_title = preferencesConfig.readUsuarioNome();
//        R.string.nav_header_pessoa = Integer.parseInt(preferencesConfig.readNivelusuario());
